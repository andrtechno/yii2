...
namespace app\system\modules\user;
use Yii;
...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    protected function checkModuleProperties()
    {
        ...
        if (!Yii::$app->request->isConsoleRequest && !Yii::$app->get("user") instanceof \app\system\modules\user\components\User) {
            throw new InvalidConfigException('Yii::$app->user is not set properly. It needs to extend \app\system\modules\user\components\User');
        }
    }
    ...
    {
        return [
            'User'       => 'app\system\modules\user\models\User',
            'Profile'    => 'app\system\modules\user\models\Profile',
            'Role'       => 'app\system\modules\user\models\Role',
            'UserKey'    => 'app\system\modules\user\models\UserKey',
            'UserAuth'   => 'app\system\modules\user\models\UserAuth',
            'ForgotForm' => 'app\system\modules\user\models\forms\ForgotForm',
            'LoginForm'  => 'app\system\modules\user\models\forms\LoginForm',
            'ResendForm' => 'app\system\modules\user\models\forms\ResendForm',
            'UserSearch' => 'app\system\modules\user\models\search\UserSearch',
        ];
    }
